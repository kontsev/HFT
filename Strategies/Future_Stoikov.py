...
# cheat
from Simulator.simulator_optimized import SimOptim
...
class Strategy:
    ...
    def cheat_activ(self):
        ...
        run_time = pd.Timedelta(20, 'm').value
        ...
        while True:
            ...
            if receive_ts - prev_time >= self.delay:
                ...
                if self.volatility is not None and self.scaled_order_intensity is not None:
                    ...
                    indifference_price = future_price - (self.asset_position/self.normalizer)*self.risk_koef*self.volatility
